...
export default function ProductCard({product}: {product: ClothProduct}) {
    ...
    return (
        <div className="snap-center col-span-2 h-fit hover:shadow-lg hover:cursor-pointer transition-all p-2">
